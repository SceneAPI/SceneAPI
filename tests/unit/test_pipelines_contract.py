"""Locks the pipeline composition core contract (sceneapi.server.core.pipelines).
...
from sceneapi.server.core import pipelines as pl
from sceneapi.server.core import processors as proc
