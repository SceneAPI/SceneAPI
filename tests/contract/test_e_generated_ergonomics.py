...
def test_chained_ergonomics_against_live_server(live_ephemeral_server: str) -> None:
    ...
    from scenesdk.models.job_detail import JobDetail as GenJobDetail
