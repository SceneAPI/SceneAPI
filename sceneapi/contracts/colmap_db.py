...
the :mod:`sceneio.colmap_db` contract package.

The contract moved into ``sceneio`` (the leaf I/O contract package)
...
from sceneio.colmap_db import *  # noqa: F403
...
from sceneio.colmap_db import (  # noqa: F401
