"""ARQ entrypoint — thin shim over ``sceneapi.server.workers.dispatcher``.
...
from sceneapi.server.core.logging import configure_logging
from sceneapi.server.workers.dispatcher import WORKER_ID, execute_task
