...
from sceneapi.server.core.optional_deps import has_opencv, has_pillow
from sceneapi.server.core.projections import (
    CUBEMAP_FACE_AXES,
    CUBEMAP_FACE_ORDER,
...
def _engine_result(
    *,
    ...
    result: dict[str, object] = {
        "engine": "sceneapi.core.projection_engine",
        "operation": operation,
        "source_images": source_images,
        "output_images": output_images,
    }
