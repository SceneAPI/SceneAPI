...
# sceneapi.server.adapters.backend_*) import instead of re-declaring the same literals.
...
# 96-char cap. Re-exported by sceneapi.server.core.artifacts (the artifact vocabulary
