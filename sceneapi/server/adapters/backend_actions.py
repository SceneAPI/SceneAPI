...
from sceneapi.server.core import colmap_actions
...
def _validate_json_inputs(
    ...
    from sceneapi.server.adapters import backend_config  # local: avoid import cycle
...
def backend_action_contract_violations(backend: Any) -> list[str]:
    ...
    .. code-block:: python
        ...
        from sceneapi.server.adapters.backend_actions import assert_backend_action_contract
