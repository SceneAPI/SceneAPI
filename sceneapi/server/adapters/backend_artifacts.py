...
from sceneapi.server.adapters import _descriptor_registry as _base
from sceneapi.server.adapters.backend import has_backend_method
...
# The config-stage vocabulary is core-owned (sceneapi.server.core.config_stages); the
...
from sceneapi.server.core.config_stages import CONFIG_STAGE_ORDER as _STAGE_ORDER  # noqa: E402
from sceneapi.server.core.config_stages import VALID_CONFIG_STAGES as _VALID_STAGES  # noqa: E402
...
def backend_io_formats(
    ...
    :func:`sceneapi.server.core.artifacts.resolve_io_formats` as the plugin overrides
