...
from sceneapi.server.core.hashing import canonical_json, content_address, stream_sha256
...
from sceneapi.server.services import artifact_service, provider_routing_service
...
async def import_artifact(
    ...
    *,
    ...
    # (sceneapi.server.db.session.get_db) commits on success.
    await session.flush()
    return row
