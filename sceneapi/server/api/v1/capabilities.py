...
UI affordances. See :mod:`sceneapi.server.core.capabilities` for the canonical
...
from sceneapi.server.schemas.api.capabilities import BackendInfoOut, CapabilitiesOut
