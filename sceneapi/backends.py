...
from sceneapi.server.adapters.backend import (
...
from sceneapi.server.adapters.backend_artifacts import (
...
from sceneapi.server.adapters.progress import (
    LogLevel,
...
class Plugin:
    ...
    Every ``[sceneapi.backends]`` entry point in the baseline has
    ...
    via :func:`sceneapi.server.adapters.registry.register_backend`. Plugin authors
