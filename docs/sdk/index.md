...
|---|---|---|
| Python generated SDK | `pip install ../sfmapi-sdk/python/scenesdk` | Use `scenesdk.Client` plus helpers in `scenesdk._ergonomics`. |
...
```bash
pip install ../sfmapi-sdk/python/scenesdk
```

```python
from scenesdk import Client
from scenesdk._ergonomics import parse_points_binary, wait_for_job

client = Client(base_url="http://localhost:8080")
```

The generated package contains endpoint modules under
`scenesdk.api`, typed models under `scenesdk.models`,
...
```python
from scenesdk import Client
from scenesdk.api.admin.install_plugin_v1_admin_plugins_plugin_id_install_post import sync
from scenesdk.models.plugin_install_request import PluginInstallRequest
from scenesdk.models.plugin_install_request_method import PluginInstallRequestMethod
...
```python
from scenesdk.api.admin.set_provider_priority_v1_admin_routing_provider_priority_post import sync
from scenesdk.models.provider_priority_request import ProviderPriorityRequest
