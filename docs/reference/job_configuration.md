...
|---|---|---|---|
| **capability** | A portable feature/stage the backend implements (`ALL_KNOWN`) | `features.extract.sift`, `radiance.train`, `pairs.from_poses` | `enum` of `app/core/capabilities.py::ALL_KNOWN` |
