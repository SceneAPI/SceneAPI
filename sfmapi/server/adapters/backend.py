...
configured backend with :func:`sfmapi.server.adapters.registry.get_backend` and
...
- Backend artifact I/O contracts live in ``sfmapi.server.adapters.backend_artifacts``
...
``progress: sfmapi.server.adapters.progress.ProgressReporter | None`` argument.
...
from sfmapi.server.adapters.progress import ProgressReporter
...
class Backend(BackendIdentity, Protocol):
    ...
    def capabilities(self) -> set[str]:
        ...
        :data:`sfmapi.server.core.capabilities.ALL_KNOWN`. Backend-native tools
