...
from sfmapi.server.adapters.backend_artifacts import backend_artifact_contract_violations
...
def _hint_unknown_capability(capability: str) -> str:
    ...
    return "; portable capabilities must be added to sfmapi.server.core.capabilities.ALL_KNOWN"
