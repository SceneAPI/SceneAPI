...
from sfmapi.server.core.errors import CapabilityUnavailableError, NotFoundError, ValidationError
from sfmapi.server.core.ids import new_id
from sfmapi.server.core.paths import Paths
from sfmapi.server.core.public_outputs import sanitize_public_error, sanitize_public_outputs
...
from sfmapi.server.services.provider_routing_service import apply_provider_resolution
...
def _check_radiance_canonical_typos(backend_options: dict[str, Any]) -> None:
    ...
    from sfmapi.server.adapters.backend_config import radiance_train_option_schema
