...
``sfmapi/server/workers/tasks/vlad_index.py`` — that requires SIFT features in
...
from sfmapi.server.core.errors import NotFoundError, PycolmapUnavailableError, ValidationError
from sfmapi.server.core.paths import Paths
from sfmapi.server.db.models import Dataset, Image
from sfmapi.server.services import dataset_service, image_bytes_service
from sfmapi.server.storage import similarity as sim
from sfmapi.server.storage import vlad as vlad_store
