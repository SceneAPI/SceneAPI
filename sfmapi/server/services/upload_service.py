...
from sfmapi.server.db.models import Blob, Upload
from sfmapi.server.services.quota_service import check_storage as check_storage_quota
from sfmapi.server.storage.blobs import TempUploadStore, get_blob_store
...
async def init_upload(
    ...
    *,
    ...
    # (single-user deployments) — see sfmapi.server.services.quota_service.
