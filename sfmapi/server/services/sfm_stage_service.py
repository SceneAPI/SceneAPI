...
``sfmapi.server.services.sfm_stage_service``; the code lives in:
...
from sfmapi.server.services._sfm_stage_recipes import (
    build_recipe_dag,
    collect_pose_priors_by_name,
    validate_recipe_stage_configs,
)
from sfmapi.server.services._sfm_stage_recon import (
