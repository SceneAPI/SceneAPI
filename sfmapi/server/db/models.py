...
from sfmapi.server.core.ids import ID_LEN, new_id
from sfmapi.server.db.base import Base
from sfmapi.server.db.types import ULIDType
...
class Image(Base):
    ...
    # PosePrior wire shape — see sfmapi.server.schemas.api.scene.PosePrior. Stored
