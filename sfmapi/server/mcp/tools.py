...
from sfmapi.server.core.capabilities import BackendInfo, empty_capabilities
...
from sfmapi.server.db.session import session_scope
from sfmapi.server.schemas.api.artifacts import (
    ArtifactConversionPlanRequest,
    ArtifactFormatOut,
    StageArtifactOut,
)
from sfmapi.server.schemas.api.backend_actions import BackendActionOut
from sfmapi.server.schemas.api.common import Page, to_out
from sfmapi.server.schemas.api.jobs import JobDetail, JobOut, JobStatus, TaskOut
from sfmapi.server.schemas.api.projects import ProjectOut
...
async def sfmapi_version() -> dict[str, Any]:
    ...
    from sfmapi.server.api.v1.health import version
...
# ``sfmapi/server/api/v1/{recon_stages,dataset_stages,sfm_stages,localize}.py``.
