...
Operation registry; sfmapi.server.core.operations remains as a compatibility projection.
"""
...
from sfmapi.server.core.attributes import Attribute, AttributeSet
from sfmapi.server.core.config_stages import VALID_CONFIG_STAGES
from sfmapi.server.core.datatypes import is_data_type
