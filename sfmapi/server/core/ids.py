...
# sfmapi.server.adapters.backend_*) import instead of re-declaring the same literals.
...
# 96-char cap. Re-exported by sfmapi.server.core.artifacts (the artifact vocabulary
