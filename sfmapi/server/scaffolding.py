...
# Same shape sfmapi.server.core.ids.PROVIDER_ID_RE enforces on provider_ids.
...
class ${class_name}Backend:
    ...
    def capabilities(self) -> list[str]:
        ...
        # The canonical vocabulary lives in sfmapi.server.core.capabilities.ALL_KNOWN.
        return []
...
# A contract name becomes a Python module name (sfmapi/server/core/<name>.py), a
...
_CONTRACT_TEST_TEMPLATE = string.Template(
    '''\
"""Contract test for sfmapi.server.core.${name} (off-wire core contract)."""

from __future__ import annotations

import json

from sfmapi.server.core import ${name} as contract
