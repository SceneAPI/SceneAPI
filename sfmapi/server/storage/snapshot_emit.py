...
``sfmapi/server/api/v1/reconstructions.py`` advertises. The emitter writes:
...
from sfmapi.server.storage._atomic import write_bytes as _atomic_write_bytes
from sfmapi.server.storage._atomic import write_text as _atomic_write_text
