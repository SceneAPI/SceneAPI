...
Mirror of :mod:`sfmapi.server.storage.two_view_emit`, but for the **raw** matches
...
from sfmapi.server.schemas.api.scene import CorrespondenceGraphFile, CorrespondencePair
