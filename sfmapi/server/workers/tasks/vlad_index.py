...
:mod:`sfmapi.server.storage.vlad` so the web tier can query without the
backend installed.
...
from sfmapi.server.storage.vlad import write_index as _write_vlad_index
from sfmapi.server.workers._materialize import resolve_image_path
