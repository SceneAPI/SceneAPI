...
from sfmapi.server.schemas.api.jobs import JobDetail, JobOut, JobProgressOut, JobStatus, TaskOut
from sfmapi.server.services import artifact_service, job_progress_service, job_service
...
async def events(
    ...
    async def gen() -> AsyncIterator[bytes]:
        from sfmapi.server.db.models import Job
