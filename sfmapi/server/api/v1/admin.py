...
from sfmapi.server.services import api_key_service, plugin_service

router = APIRouter(prefix="/admin", tags=["admin"])

# Preview tier (SPEC §1.3 [Preview]): mounted unconditionally in
# sfmapi.server.main, but only included in the OpenAPI document when
