...
UI affordances. See :mod:`sfmapi.server.core.capabilities` for the canonical
...
from sfmapi.server.schemas.api.capabilities import BackendInfoOut, CapabilitiesOut
